...
const GroupOrderInvitation = lazy(() => import('../pages/GroupOrderInvitation'));
...
const SubmitInvoiceVendorReviewPage = lazy(() => import('../pages/SubmitInvoiceVendorReviewPage'));
...
const PublicRoutes = (
  <>
    ...
    <Route path="/marketplace" element={
      <Suspense fallback={<div className="min-h-screen bg-muted/5 animate-pulse" />}>
        <Marketplace />
      </Suspense>
    } />
    ...
    <Route path="/order-summary/:invoiceId" element={
      <Suspense fallback={<div className="min-h-screen bg-muted/5 animate-pulse" />}>
        <OrderSummaryPage />
      </Suspense>
    } />
    <Route path="/group-order/host-summary/:invoiceId" element={
      <Suspense fallback={<div className="min-h-screen bg-muted/5 animate-pulse" />}>
        <OrderSummaryPage />
      </Suspense>
    } />
    <Route path="/invoices/thank-you/:id" element={
      <Suspense fallback={<div className="min-h-screen bg-muted/5 animate-pulse" />}>
        <InvoiceThankYouPage />
      </Suspense>
    } />
    <Route path="/invoices/declined" element={
      <Suspense fallback={<div className="min-h-screen bg-muted/5 animate-pulse" />}>
        <InvoiceDeclinedPage />
      </Suspense>
    } />
    ...
    <Route path="/proposals/thank-you" element={
      <Suspense fallback={<div className="min-h-screen bg-muted/5 animate-pulse" />}>
        <InvoiceThankYouPage />
      </Suspense>
    } />
    ...
    <Route path="/events/:id/rsvp/:guestId" element={
      <Suspense fallback={<div className="min-h-screen bg-muted/5 animate-pulse" />}>
        <EventRsvpPage />
      </Suspense>
    } />
    ...
    <Route path="/group-order/invite/:id" element={
      <Suspense fallback={<div className="min-h-screen bg-muted/5 animate-pulse" />}>
    ...
    <Route path="/submit-reviews" element={
      <Suspense fallback={<div className="min-h-screen bg-muted/5 animate-pulse" />}>
        <SubmitReviewsPage />
      </Suspense>
    } />
    ...
    <Route path="/reviews/vendor/:vendorId" element={
      <Suspense fallback={<div className="min-h-screen bg-muted/5 animate-pulse" />}>
        <ReviewsPage />
      </Suspense>
    } />
    <Route path="/reviews/invoice/:invoiceId" element={
      <Suspense fallback={<div className="min-h-screen bg-muted/5 animate-pulse" />}>
        <InvoiceReviewsPage />
      </Suspense>
    } />
    <Route path="/reviews/invoice/:invoiceId/vendor/:vendorId" element={
      <Suspense fallback={<div className="min-h-screen bg-muted/5 animate-pulse" />}>
