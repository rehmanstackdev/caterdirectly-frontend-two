...
import HostsManagment from "@/pages/admin/HostsManagment";
...
const AdminRoutes = (
  <>
    ...
    />
    <Route
      path="/admin/calendar-availbility"
      element={
        <ProtectedRoute userRole="admin">
          <AdminCalendarPage />
        </ProtectedRoute>
    ...
    />
    <Route
      path="/admin/invoices/create/:serviceId"
      element={
        <ProtectedRoute userRole="admin">
          <CreateInvoicePage />
        </ProtectedRoute>
    ...
    />
    <Route
      path="/admin/create-vendor-service"
      element={
        <ProtectedRoute userRole="admin">
          <CreateVendorService />
        </ProtectedRoute>
