...
import { Upload, Download, File, CheckCircle, AlertTriangle } from 'lucide-react';
...
const GuestImport = () => {
  ...
  const downloadTemplate = () => {
    // Create CSV template
    const template = 'Name,Email,Phone,Company,JobTitle,Tags\n';
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Upload a CSV file with your guest data</CardDescription>
              </CardHeader>
              <CardContent>
                  ...
                  <div className="space-y-4">
                    ...
                    {importStatus === 'error' && (
                      <Alert variant="destructive">
                        ...
                        <AlertDescription>
                          There was an error importing your contacts. Please check your file format and try again.
                        </AlertDescription>
                      </Alert>
                    )}
                    ...
                    <div className="text-sm text-gray-500">
                      ...
                      <ul className="list-disc pl-5 mt-2">
                        ...
                        <li>Optional columns: Phone, Company, JobTitle, Tags</li>
                      </ul>
                    </div>
                  </div>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="p-3 bg-blue-50 rounded-lg">
                    ...
                    <p className="text-sm text-blue-600">
                      Separate multiple tags with semicolons (e.g., "VIP;Friend;Colleague").
                    </p>
                  </div>
                  <div className="p-3 bg-blue-50 rounded-lg">
                    <h4 className="font-semibold text-blue-700">Duplicates</h4>
                    <p className="text-sm text-blue-600">
                      Entries with emails matching existing contacts will update those contacts.
                    </p>
                  </div>
                </div>
              </CardContent>
        ...
        <TabsContent value="export">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Download your contacts as a CSV file</CardDescription>
            </CardHeader>
            <CardContent className="text-center py-8">
              ...
              <p className="text-gray-500 max-w-md mx-auto mb-6">
                Export your complete guest database to a CSV file that you can open in Excel or Google Sheets.
              </p>
