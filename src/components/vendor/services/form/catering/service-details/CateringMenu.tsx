...
const CateringMenu: React.FC<CateringMenuProps> = ({
  ...
  console.log('=== CATERING MENU RENDER ===');
  console.log('formData.menuItems:', formData.menuItems);
  console.log('formData.combos:', formData.combos);
  console.log('showMenuItemForm:', showMenuItemForm);
  return (
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-500">
            Add menu items with specific pricing, dietary restrictions and allergen information
          </p>
        </div>
        <Button
      ...
      <div className="border-b pb-6 space-y-4">
        <div>
          <Label className="flex items-center gap-2">
            Menu Photo
            <span className="text-xs text-gray-500 font-normal">(Overall photo of your menu or featured dish)</span>
          </Label>
          <p className="text-sm text-gray-500 mb-2">This image will be displayed prominently in your service listing</p>
        </div>
