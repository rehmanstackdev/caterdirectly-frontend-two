...
const VendorCardHeader = ({
  ...
  return (
    <div className="flex items-start gap-3 sm:gap-4 w-full overflow-x-hidden">
      ...
      <div className="flex-1 min-w-0 pt-1 w-full overflow-x-hidden">
        <div className="flex flex-col sm:flex-row sm:items-start gap-1 sm:gap-2 mb-2 w-full overflow-x-hidden">
          <h3 className="font-bold text-sm sm:text-base md:text-lg leading-tight break-words flex-1 min-w-0 overflow-x-hidden">
        ...
        <p className="text-xs sm:text-sm md:text-base text-gray-600 leading-relaxed break-words min-w-0 overflow-x-hidden">
          <span className="block truncate max-w-full">
