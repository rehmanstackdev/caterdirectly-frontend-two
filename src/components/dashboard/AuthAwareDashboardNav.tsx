...
export function AuthAwareDashboardNav({
  activeTab,
  userRole,
  onLogout,
  className,
  onNavigate,
}: AuthAwareDashboardNavProps) {
  const { user } = useAuth();
  ...
  const eventHostLinks = [
    ...
    },
    {
      name: "Orders & Reviews",
      id: "analytics",
      href: "/host/analytics?section=orders",
  ...
  const adminLinks = [
    ...
    },
    {
      ...
      protected: true,
      pageId: "leads",
    }, // Map leads to proposals permission
    {
      name: "Waitlist",
      id: "waitlist",
      href: "/admin/waitlist",
    ...
    },
    {
      ...
      protected: true,
      pageId: "proposals",
    }, // Map messages to proposals permission
    {
      name: "Finances",
      id: "finances",
      href: "/admin/finances",
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                cn(
                  ...
                  {
                    "bg-[#F07712] text-white shadow-sm":
                      (isActive ||
                        isFallbackActive ||
                        isInvoiceFallbackActive) &&
                      !isDisabled,
