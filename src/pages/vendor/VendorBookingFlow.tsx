    ...
    try {
      ...
      const invoiceData = {
        ...
        services: selectedServices.map((service) => ({
          ...
          vendorId:
            (service as any).vendor_id || (service as any).vendorId || "",
          ...
          if (matchingRange) {
            setServiceDeliveryFees((prev) => {
              ...
              try {
                ...
                console.warn(
                  "[VendorBookingFlow] Failed to persist delivery fees:",
                  error,
                );
              }
              return updated;
    ...
    (address: string, locationData?: LocationData) => {
      if (locationData) {
        ...
        try {
          ...
          console.warn(
            "[VendorBookingFlow] Failed to persist location data:",
            error,
          );
        }
        console.log(
          "[VendorBookingFlow] Location selected with coordinates:",
          locationData,
        );
      }
    },
                            ...
                            onClick={async (e) => {
                              ...
                              try {
                                  ...
                                  if (
                                    ...
                                    const venueVendor =
                                      ...
                                      service.vendor !== null
                                        ...
                                        : service.service_details?.vendor ||
                                          null;
                                    ...
                                    return {
                                      ...
                                      vendor: venueVendor
                                        ? {
                                            ...
                                            name:
                                              venueVendor.name ||
                                              venueVendor.business_name ||
                                              venueVendor.vendorName,
                                            address:
                                              venueVendor.full_address ||
                                              venueVendor.address ||
                                              venueVendor.street_address,
                                            city: venueVendor.city,
                                            state: venueVendor.state,
                                            zipCode:
                                              venueVendor.zip_code ||
                                              venueVendor.zipCode,
                                            phone:
                                              venueVendor.phone ||
                                              venueVendor.phone_number,
                                  ...
                                  if (
                                    ...
                                    return {
                                      ...
                                      vendor: nonCateringVendor
                                        ? {
                                            id:
                                              nonCateringVendor.id ||
                                              service.vendor_id,
                                            name:
                                              nonCateringVendor.name ||
                                              nonCateringVendor.business_name ||
                                              nonCateringVendor.vendorName,
                                            address:
                                              nonCateringVendor.full_address ||
                                              nonCateringVendor.address ||
                                              nonCateringVendor.street_address,
                                            city: nonCateringVendor.city,
                                            state: nonCateringVendor.state,
                                            zipCode:
                                              nonCateringVendor.zip_code ||
                                              nonCateringVendor.zipCode,
                                            phone:
                                              nonCateringVendor.phone ||
                                              nonCateringVendor.phone_number,
                                ...
                                try {
                                  ...
                                  console.warn(
                                    "[VendorBookingFlow] Failed to clear localStorage:",
                                    error,
                                  );
                                }
                                ...
                                if (invoiceId) {
                                  navigate(
                                    "/vendor/order-summary/" + invoiceId,
                                  );
                                }
                              } catch (error) {
                                console.error(
