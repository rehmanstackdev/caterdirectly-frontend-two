...
function AdminGroupOrderSetup() {
  ...
  const handleCreateGroupOrder = async () => {
    ...
    //   toast.error("Please select menu items before creating the group order.");
    //   return;
    // }
    ...
    try {
      ...
      const mapServiceWithItems = (service: any, index: number) => {
        ...
        Object.entries(state.selectedItems).forEach(([itemId, quantity]) => {
          ...
          // Only process if item is found (catering only at this point)
          if (!item) {
...
export default AdminGroupOrderSetup;
